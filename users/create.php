...
if (isset($_POST['txtUsername'])) {
    ...
    if ($result) {
        echo "<div class='container'>
              <h3>Created user successfully.</h3><br/>
              <p class='link'>Click here to <a href='/udweb'>back</a></p>
              </div>";
    } else {
        echo "<div class='form'>
                <h3>Required fields are missing.</h3><br/>
                <p class='link'>Click here to <a href='users/create.php'>registration</a> again.</p>
                </div>";
    }
} else {
?>
    ...
    <div class="container">
        <form action="" method="post">
            ...
            <a href="/udweb" class="btn btn-default">Cancel</a>
        </form>
    </div>
